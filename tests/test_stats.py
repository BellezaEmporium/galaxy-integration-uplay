...
def test_no_candidate():
    ...
    assert find_times(statscards=cards) == (DEFAULT, DEFAULT)
...
def test_playtime_one_timestamp():
    ...
    assert find_times(statscards=cards) == (300, DEFAULT)
...
def test_playtime_one_zero():
    ...
    assert find_times(statscards=cards) == (int(timeplayed), DEFAULT)
...
def test_playtime_one_timestamp_round():
    ...
    assert find_times(statscards=cards) == (timeplayed_min, DEFAULT)
...
def test_playtime_good_name():
    ...
    assert find_times(statscards=cards) == (t, DEFAULT)
...
def test_playtime_assasin_collection():
    ...
    assert find_times(statscards=cards) == (total_min, DEFAULT)
...
def test_two_modes():
    ...
    assert find_times(statscards=cards) == (total, DEFAULT)
...
def test_gametimes_two_modes_with_last_times_hours():
    ...
    assert find_times(statscards=cards) == (total, newer_modify_timestamp)
...
def test_default_values_when_not_played():
    ...
    assert find_times(statscards=cards) == (0, 0)


def test_gametimes_champions_of_anteria():
    """Buggy uplay game stats. 'Hours' in this case should be treated as 'Milliseconds'"""
    playtime_min = 1
    ...
    assert find_times(statscards=cards, game_id='4b20d5ee-461e-4d27-8c56-e258577c5ed3') == (playtime_min, 1492726805)
...
def only_last_played():
    ...
    assert find_times(statscards=cards) == (DEFAULT, last_modified_timestamp)
...
def test_gametimes_farcry5():
    ...
    assert find_times(statscards=cards) == (total_playtime_min, last_modified_timestamp)
...
def test_gamestime_trackmania():
    ...
    assert find_times(statscards=cards)[0] == total_playtime_min
